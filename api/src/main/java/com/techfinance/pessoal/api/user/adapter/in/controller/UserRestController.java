...
public class UserRestController {
    ...
    public ResponseEntity<UserResponse> create(@Valid @RequestBody UserRequest request) {
        return ResponseEntity.status(HttpStatus.CREATED).body(UserResponse.from(service.create(request)));
    }
    ...
    public ResponseEntity<UserResponse> findByUsername(
        ...
        return ResponseEntity.status(HttpStatus.OK).body(UserResponse.from(service.byUsername(username)));
    }
